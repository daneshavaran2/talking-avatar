...
scripts/verify-resilience.ts   تنزل تدریجی و تلاش مجدد (§۱۲)
...
npm run verify:resilience  # تنزل تدریجی و تلاش مجدد §۱۲ (۱۳ بررسی)
```
...
**دو ایراد واقعی که همین آزمون‌ها پیدا کردند و اصلاح شدند**
